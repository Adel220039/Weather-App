...
document.querySelector('.search-input').className = `search-input error-shit ${savedTheme}`;
...
document.querySelector('.suggestions-dropdown').className = `suggestions-dropdown ${savedTheme}`;
...
document.querySelector('.profile-setion').className = `profile-setion ${savedTheme}`;
...
radios.forEach(radio => {
  radio.addEventListener('change', () => {
    ...
    document.querySelector('.search-input').className = `search-input error-shit ${selectedTheme}`;
    document.querySelector('.search-btn').className = `search-btn ${selectedTheme}`;
    document.querySelector('.profile').className = `profile ${selectedTheme}`;
    document.querySelector('header .error').className = `error ${selectedTheme}`;
    document.querySelector('.suggestions-dropdown').className = `suggestions-dropdown ${selectedTheme}`;
    document.querySelectorAll('.suggestions-dropdown .suggestion-item').forEach(item => {
    ...
    document.querySelector('.profile-setion').className = `profile-setion ${selectedTheme}`;
